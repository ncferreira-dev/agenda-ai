        ...
        {method === 'choose' ? (
          ...
          <form onSubmit={onSubmit}>
            ...
            <label className={styles.field}>
              ...
              <input className={styles.input} type="email" autoComplete="email" value={email} onChange={(e) => setEmail(e.target.value)} required autoFocus />
            </label>
            <label className={styles.field}>
            ...
            <button className={styles.methodBack} type="button" onClick={() => setMethod('choose')}>
